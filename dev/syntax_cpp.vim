...
syn keyword cppIOStream         cin cout endl

syn match cppNamespace "\v[a-zA-Z_0-9]+::"
syn match cppAttribute "\v\[\[[a-zA-Z_0-9]*\]\]"
...
hi def link cppNamespace StorageClass
hi def link cppAttribute Include
